            ...
            ZStack {
                ...
                VStack{
                    ...
                    ScrollView(.horizontal) {
                        HStack(){
                            ForEach(game.player1.characters, id: \.self.id){ identifiableCharacter in
                                renamableCard(character: identifiableCharacter)
...
struct renamableCard: View {
    ...
    var body: some View {
        ...
        .onSubmit {
            game.renamePlayer1(for: character.id, with: name)
        }
    }
}
